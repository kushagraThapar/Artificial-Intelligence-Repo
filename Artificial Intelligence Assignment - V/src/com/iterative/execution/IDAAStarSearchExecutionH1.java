...
import com.iterative.implementation.IDAAStarSearchImplementationH1;
 ...
 */
public class IDAAStarSearchExecutionH1 {
    ...
    public static void main(String[] args) {
        ...
        IDAAStarSearchImplementationH1 idaaStarSearchImplementationH1 = new IDAAStarSearchImplementationH1();
        idaaStarSearchImplementationH1.initializeAStarSearch(inputPuzzle);
    ...
    public static void initializeNumberStringMap() {
        IDAAStarSearchImplementationH1.numberCharacterMap.put(10, "A");
        IDAAStarSearchImplementationH1.numberCharacterMap.put(11, "B");
        IDAAStarSearchImplementationH1.numberCharacterMap.put(12, "C");
        IDAAStarSearchImplementationH1.numberCharacterMap.put(13, "D");
        IDAAStarSearchImplementationH1.numberCharacterMap.put(14, "E");
        IDAAStarSearchImplementationH1.numberCharacterMap.put(15, "F");
    }
    ...
    public static String verifyInputState(String state) {
        ...
        for (String str : inputArray) {
            ...
            if (Integer.parseInt(str) >= 10) {
                newInput += IDAAStarSearchImplementationH1.numberCharacterMap.get(Integer.parseInt(str));
            } else {
                newInput += str;
            }
        }
