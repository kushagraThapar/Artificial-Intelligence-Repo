package com.astar.execution;

import com.astar.implementation.AStarSearchImplementationH2;
 ...
 */
public class AStarSearchExecutionH2 {
    /**
    ...
    public static void main(String[] args) {
        ...
        AStarSearchImplementationH2 aStarSearchImplementationH2 = new AStarSearchImplementationH2();
        aStarSearchImplementationH2.initializeAStarSearch(inputPuzzle);
    ...
    public static void initializeNumberStringMap() {
        AStarSearchImplementationH2.numberCharacterMap.put(10, "A");
        AStarSearchImplementationH2.numberCharacterMap.put(11, "B");
        AStarSearchImplementationH2.numberCharacterMap.put(12, "C");
        AStarSearchImplementationH2.numberCharacterMap.put(13, "D");
        AStarSearchImplementationH2.numberCharacterMap.put(14, "E");
        AStarSearchImplementationH2.numberCharacterMap.put(15, "F");
    }
    ...
    public static String verifyInputState(String state) {
        ...
        for (String str : inputArray) {
            ...
            if (Integer.parseInt(str) >= 10) {
                newInput += AStarSearchImplementationH2.numberCharacterMap.get(Integer.parseInt(str));
            } else {
                newInput += str;
            }
        }
