...
import com.astar.implementation.AStarSearchImplementationH1;
 ...
 */
public class AStarSearchExecutionH1 {
    /**
    ...
    public static void main(String[] args) {
        ...
        AStarSearchImplementationH1 aStarSearchImplementationH1 = new AStarSearchImplementationH1();
        aStarSearchImplementationH1.initializeAStarSearch(inputPuzzle);
    ...
    public static void initializeNumberStringMap() {
        AStarSearchImplementationH1.numberCharacterMap.put(10, "A");
        AStarSearchImplementationH1.numberCharacterMap.put(11, "B");
        AStarSearchImplementationH1.numberCharacterMap.put(12, "C");
        AStarSearchImplementationH1.numberCharacterMap.put(13, "D");
        AStarSearchImplementationH1.numberCharacterMap.put(14, "E");
        AStarSearchImplementationH1.numberCharacterMap.put(15, "F");
    }
    ...
    public static String verifyInputState(String state) {
        ...
        for (String str : inputArray) {
            ...
            if (Integer.parseInt(str) >= 10) {
                newInput += AStarSearchImplementationH1.numberCharacterMap.get(Integer.parseInt(str));
            } else {
                newInput += str;
            }
        }
